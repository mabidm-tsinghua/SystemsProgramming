	...
	//
     //How to run:  1. first use this command so that file is created: RecordAccess.exe filename num_records
     //             2. Second use this command to open a file for R/W records: RecordAccess.exe filename or RecordAccess.exe filename 0
